...
if p_value < 0.05:
    ...
    st.write("**Conclusion:** Fail to reject the null hypothesis. There is not enough evidence to suggest that average user ratings for Action and Sports genres are different.")#Initialization
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import seaborn as sns
